This file is a description of my codes for CMPT-431 assignment 3.

For the rogues and cleaners in which the transactions are not used, please test codes in this folder. If you find there is something wrong with the commands below, please check in the Makefile file. Thank you.
...
to get:
	...
	Get lock first, then check the lane
